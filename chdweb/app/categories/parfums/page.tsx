...
export default function ParfumsPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      setLoading(true)
      const { data, error } = await supabase.from("products").select("*").eq("category", "Parfums")
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection direction="up" delay={100}>
            <div className="text-center mb-12">
              <h1 className="text-3xl font-extrabold text-[#b89b6a] mb-2">Parfums</h1>
              <p className="text-base text-gray-500 mb-6">Parfums authentiques pour toutes les occasions.</p>
