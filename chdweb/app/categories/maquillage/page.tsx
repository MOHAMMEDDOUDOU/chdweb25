...
export default function MaquillagePage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      setLoading(true)
      const { data, error } = await supabase.from("products").select("*").eq("category", "Maquillage")
        ...
        <div className="container mx-auto px-4">
          <AnimatedSection direction="up" delay={100}>
            <div className="text-center mb-12">
              <h1 className="text-3xl font-extrabold text-[#b89b6a] mb-2">Maquillage</h1>
              <p className="text-base text-gray-500 mb-6">Maquillage de qualité pour toutes vos envies beauté.</p>
