-- إنشاء جدول الطلبات محدث مع معلومات إعادة البيع
CREATE TABLE IF NOT EXISTS orders (
  ...
  reseller_name VARCHAR(255), -- اسم من أعاد البيع
  reseller_phone VARCHAR(30), -- رقم هاتف من أعاد البيع
  reseller_user_id UUID, -- معرف المستخدم إذا كان مسجل دخول
